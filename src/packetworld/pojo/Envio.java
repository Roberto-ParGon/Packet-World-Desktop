...
public class Envio {
    ...
    // Métodos alias/compatibilidad que ya usaba tu controlador
    public Integer getClientId() { return this.idCliente; }
    public void setClientId(Integer clientId) { this.idCliente = clientId; }

    public String getTracking() { return this.numGuia; }
    public void setTracking(String tracking) { this.numGuia = tracking; }

    public String getFecha() { return this.fechaCreacion; }
    public void setFecha(String fecha) { this.fechaCreacion = fecha; }

    public String getOrigen() { return idSucursalOrigen == null ? "" : String.valueOf(idSucursalOrigen); }
    public void setOrigen(String origen) {
        if (origen == null || origen.trim().isEmpty()) { this.idSucursalOrigen = null; return; }
        try { this.idSucursalOrigen = Integer.parseInt(origen.trim()); } catch (NumberFormatException ex) { this.idSucursalOrigen = null; }
    }

    public String getDestino() { return this.direccionDestino; }
    public void setDestino(String destino) { this.direccionDestino = destino; }

    public String getEstado() { return this.estatus; }
    public void setEstado(String estado) { this.estatus = estado; }
}